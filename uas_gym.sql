...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jun 2025 pada 16.13
...
(1, 'Achmad Sofyan', 'Laki-laki', '1990-05-15', '081234567890', 'aspro@email.com', 'Jl. Sudirman No. 123', '2025-06-08', 'Aktif', '2025-06-08 05:03:47', '2025-06-08 08:47:23'),
(2, 'Hanifah', 'Perempuan', '1985-08-22', '081234567891', 'haniff@email.com', 'Jl. Thamrin No. 456', '2025-06-08', 'Aktif', '2025-06-08 05:03:47', '2025-06-08 08:48:52'),
(3, 'Elvis Sukaesih', 'Laki-laki', '1992-03-10', '081234567892', 'viss@email.com', 'Jl. Gatot Subroto No. 789', '2025-06-08', 'Aktif', '2025-06-08 05:03:47', '2025-06-08 08:48:28'),
(4, 'Nabila', 'Perempuan', '1988-12-05', '081234567893', 'bilaaa@email.com', 'Jl. Kuningan No. 321', '2025-06-08', 'Aktif', '2025-06-08 05:03:47', '2025-06-08 08:49:43'),
(5, 'zazacky', 'Laki-laki', '1995-07-18', '081234567894', 'jekkk@email.com', 'Jl. Senayan No. 654', '2025-06-08', 'Aktif', '2025-06-08 05:03:47', '2025-06-08 08:50:05');
...
(11, 1, 'Minggu', '10:00:00', '22:00:00', '0000-00-00', NULL, '2025-06-08 10:06:57'),
(12, 5, 'Sabtu', '08:00:00', '22:00:00', '0000-00-00', NULL, '2025-06-09 10:44:16'),
(13, 5, 'Selasa', '08:00:00', '22:00:00', '0000-00-00', NULL, '2025-06-09 10:44:42');

-- --------------------------------------------------------

--
-- Struktur dari tabel `jadwal_pelatih`
--
...
--
-- Dumping data untuk tabel `jadwal_pelatih`
--
...
(4, 4, 3, '2024-06-10', '2024-07-10', 'Berakhir', '2025-06-08 05:03:47', '2025-06-09 09:59:43'),
...
(9, 5, 1, '2025-06-08', '2025-06-09', 'Suspend', '2025-06-08 06:04:51', '2025-06-09 09:59:54'),
(10, 4, 1, '2025-06-08', '2025-06-09', 'Aktif', '2025-06-08 06:21:07', '2025-06-08 06:21:07'),
(11, 1, 6, '2025-06-09', '2026-06-09', 'Aktif', '2025-06-09 10:04:31', '2025-06-09 10:04:31');
...
--
-- Struktur dari tabel `paket_keanggotaan`
--
...
--
-- Dumping data untuk tabel `paket_keanggotaan`
--
...
(1, 'Sarah ', 'Yoga, Pilates, Stretching', '081234567893', 'sarah@gym.com', 'Jl. BudimanNo. 15', '2025-06-08', 8000000.00, 'Aktif', '2025-06-08 05:03:47', '2025-06-09 10:45:43'),
(2, 'Rezeki Agus', 'HIIT, Strength Training, CrossFit', '081234567894', 'agus@gym.com', 'Jl. Buangan No. 22', '2025-06-08', 9000000.00, 'Aktif', '2025-06-08 05:03:47', '2025-06-09 10:46:27'),
(3, 'Aurora', 'Aerobik, Dance Fitness, Zumba', '081234567895', 'aurora@gym.com', 'Jl. Ajadulu No. 8', '2025-06-08', 7500000.00, 'Aktif', '2025-06-08 05:03:47', '2025-06-09 10:47:38'),
(4, 'John Angger', 'Personal Training, Bodybuilding', '081234567896', 'John@gym.com', 'Jl. Tatau No. 12', '2025-06-08', 10000000.00, 'Aktif', '2025-06-08 05:03:47', '2025-06-09 10:48:34');
...
(8, 3, 75000.00, '2025-06-08', 'Tunai', 'Lunas', 'Yoga Morning', NULL, '2025-06-08 08:18:28', '2025-06-09 10:03:46'),
(9, 1, 100000.00, '2025-06-09', 'Tunai', 'Pending', 'HIIT Training', NULL, '2025-06-09 10:04:05', '2025-06-09 10:04:05'),
(10, 11, 4500000.00, '2025-06-09', 'Tunai', 'Lunas', '', NULL, '2025-06-09 10:04:31', '2025-06-09 10:04:47');
...
CREATE TABLE `pengguna` (
  ...
  `alamat` text DEFAULT NULL,
  `peran` enum('admin','member') DEFAULT 'member',
...
INSERT INTO `pengguna` (`id_pengguna`, `nama_lengkap`, `email`, `kata_sandi`, `no_telepon`, `jenis_kelamin`, `tanggal_lahir`, `alamat`, `peran`, `tanggal_dibuat`) VALUES
(2, 'ACHMAD SOFYAN', 'achmadspro@gmail.com', '$2y$10$6cgJXnoz91l538aipX.2DON4TQeBiRwEpAKSVbHgtnV1ZmlgO9Lnu', '083890103616', 'Laki-laki', '2001-08-28', 'JL. H. SAALAN RT 03 RW 03 NO 256', 'member', '2025-05-28 00:00:00'),
(3, 'admin gym', 'admin@gym.com', '$2y$10$SEBZzFYLJJF.eDHZ9/E7BOjnUx7wvKdL5mT04lAImrK8Q2qLdXcMS', '083890103616', 'Laki-laki', '2025-06-09', 'JL. H. SAALAN RT 03 RW 03 NO 25', '', '2025-06-09 00:00:00');

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `view_anggota_aktif`
...
--
-- Stand-in struktur untuk tampilan `view_jadwal_kelas_lengkap`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Stand-in struktur untuk tampilan `view_laporan_pembayaran`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Struktur untuk view `view_anggota_aktif`
--
...
--
-- Struktur untuk view `view_jadwal_kelas_lengkap`
--
...
--
-- Struktur untuk view `view_laporan_pembayaran`
--
...
--
-- Indeks untuk tabel `jadwal_pelatih`
--
...
--
-- Indeks untuk tabel `paket_keanggotaan`
--
...
--
ALTER TABLE `jadwal_kelas`
  MODIFY `id_jadwal_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `jadwal_pelatih`
--
ALTER TABLE `jadwal_pelatih`
...
--
ALTER TABLE `keanggotaan`
  MODIFY `id_keanggotaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT untuk tabel `paket_keanggotaan`
--
ALTER TABLE `paket_keanggotaan`
...
--
-- Ketidakleluasaan untuk tabel `jadwal_pelatih`
--
ALTER TABLE `jadwal_pelatih`
